...
public class CalcTest {
    ...
    void t9() {
        Assertions.assertThat(Calc.run("10 - 20 + 30")).isEqualTo(20);
    }

    @Test
    @DisplayName("10 - 10 - 10 - 10 == -20")
    void t10() {
        Assertions.assertThat(Calc.run("10 - 10 - 10 - 10")).isEqualTo(-20);
    }

    @Test
    @DisplayName("10 - 10 - 10 - 10 + 10 + 10 - 10 == -10")
    void t11() {
        Assertions.assertThat(Calc.run("10 - 10 - 10 - 10 + 10 + 10 - 10")).isEqualTo(-10);
    }

    @Test
    @DisplayName("10 * 10 == 100")
    void t12() {
        Assertions.assertThat(Calc.run("10 * 10")).isEqualTo(100);
    }
    ...
    void t14() {
        Assertions.assertThat(Calc.run("10 * 10 * 10")).isEqualTo(1000);
    }

    @Test
    @DisplayName("10 + 5 * 2 == 20")
    void t15() {
        Assertions.assertThat(Calc.run("10 + 5 * 2")).isEqualTo(20);
    }

    @Test
    @DisplayName("20 + 10 + 5 * 2 == 40")
    void t16() {
        Assertions.assertThat(Calc.run("20 + 10 + 5 * 2")).isEqualTo(40);
    }
    ...
    @DisplayName("5 - (1 + 5) == -1")
    void t27() {
        Assertions.assertThat(Calc.run("5 - (1 + 5)")).isEqualTo(-1);
    }
